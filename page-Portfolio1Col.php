  ...
  <?php if ( ! have_posts() ) : ?>
	<div id="post-0" class="post error404 not-found">
		...
		<div class="entry-content">
			<p><?php _e( 'cxcxcApologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'theme1765' ); ?></p>
			<?php get_search_form(); ?>
		</div><!-- .entry-content -->
	</div><!-- #post-0 -->
<?php endif; ?>
  ...
  <ul class="portfolio">
    ...
    ?>
      ...
      <li class="<?php echo $addclass; ?>">
        ...
        <span class="image-border"><a class="image-wrap" href="<?php echo $img_url;?>" rel="<?php echo $prettyType; ?>" title="<?php the_title();?>"><img src="<?php echo $image ?>" alt="<?php the_title(); ?>" /><span class="zoom-icon"><span class="text"><?php _e('ZOOM','theme1765'); ?></span></span></a></span>
        ...
        <span class="image-border"><a class="image-wrap" href="<?php the_permalink() ?>" title="<?php _e('Permanent Link to', 'theme1765');?> <?php the_title_attribute(); ?>" ><img src="<?php echo $image ?>" alt="<?php the_title(); ?>" /></a></span>
        ...
        <div class="folio-desc">
					...
					<p class="excerpt"><?php $content = get_the_content(); echo my_string_limit_words($content,120);?></p>
