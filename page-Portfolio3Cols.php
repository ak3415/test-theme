...
<div id="content" class="grid_12">
  ...
  <?php $temp = $wp_query;
	$wp_query= null;
	$wp_query = new WP_Query(); ?><?php echo '<pre>'; print_r($wp_query); die('dfdfd') ?>
  <?php $wp_query->query("post_type=portfolio&". $catinclude ."&paged=".$paged.'&showposts=16'); ?>
  <?php if ( ! have_posts() ) : ?>
    ...
    ?>
      ...
      <li class="<?php echo $addclass; ?>">
        ...
        <div class="folio-desc">
          ...
          <?php $excerpt = get_the_excerpt(); echo my_string_limit_words($excerpt,32);?>
        </div>
