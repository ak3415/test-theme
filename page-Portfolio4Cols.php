  ...
  <ul class="portfolio">
    ...
    ?>
      ...
      <li class="<?php echo $addclass; ?>">
			 ...
			 //check thumb and media type
				if(has_post_thumbnail($post->ID) && $mediaType != 'Video' && $mediaType != 'Audio'){ 
					...
					if($mediaType != 'Image') { 
					   ...
					   <a id="video-anchor<?php //echo the_id();?>"  class="image-wrap" href="<?php the_permalink(); ?>" rel="<?php //echo $prettyType; ?>" title="<?php the_title();?>">
					       <img src="<?php echo $image; ?>" alt="<?php the_title(); ?>" />
					       <!--<span class="zoom-icon"><span class="text"><?php //_e('ZOOM','theme1765'); ?></span></span>-->
					   </a>
				       </span>
        ...
        <span class="image-border">
	    <a class="image-wrap" href="<?php the_permalink() ?>" title="<?php _e('Permanent Link to', 'theme1765');?> <?php the_title_attribute(); ?>" >
		<img src="<?php echo $image ?>" alt="<?php the_title(); ?>" />
	    </a>
	</span>
        ...
        <div class="folio-desc">
          ...
          <input type="hidden" id="video-hidden<?php echo the_id();?>" value="<?php the_permalink(); ?>">
