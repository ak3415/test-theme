...
$wp_query->query('cat=839'.'&paged='.$paged);
$my_query = new WP_Query( array( 'category_name' => 'featured-videos', 'paged' => get_query_var('paged') ) );
...
<div class="video-item">
    ...
    <?php endwhile; endif; wp_pagenavi( array( 'query' => $my_query ) );
